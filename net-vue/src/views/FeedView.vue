    ...
    <div class="mx-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-3 space-y-4">
            ...
            <div 
                ...
                v-bind:key="post.id"
            >    
            <!--the value post come form the above codes and the right post is the parameter that will be passed along
             and it is a must for us to bind it   -->
...
export default {
    ...
    methods: {
        getFeed() {
            // this is for getting the posted information from the backend 
            axios
               .get('/api/post/')
               .then(response => {
        ...
        submitForm() { 
            // this axios here is for enabling a user to post a certain information online 
