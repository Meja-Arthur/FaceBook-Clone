              ...
              <div class="space-y-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-2">
                        ...
                        <p class="text-xs"><strong>code with Arthur</strong></p>
                    </div>
                    <span class="text-xs text-gray-500">10 minites ago</span>
        ...
        <div class="bg-white border border-gray-200 rounded-lg">
            ...
            <div class="flex flex-col flex-grow p-4">
                ...
                <div class="flex w-full mt-2 space-x-3 max-w-md ml-auto justify-end">
                    <div>
                        <div class="bg-blue-600 text-white p-3 rounded-l-lg rounded-br-lg">
                            <p class="text-sm">Do you wanna play the victim Joshua right now  </p>
                        </div>
                        <span class="text-xs text-gray-500 leading-none">2 min ago</span>
                    </div>
                ...
                <div class="flex w-full mt-2 space-x-3 max-w-md">
                    ...
                    <div>
                        <div class="bg-gray-300 p-3 rounded-r-lg rounded-bl-lg">
                            <p class="text-xs">What did you just say to me Medusa?</p>
                        </div>
                        <span class="text-xs text-gray-500 leading-none">2 min ago</span>
                    </div>
                </div>
