      ...
      <div class="flex items-center justify-between">
        ...
        <div class="menu-right">
          ...
          <template v-else>
            ...
            <RouterLink  to="/signup" class="py-4 px-6 bg-purple-600 text-white rounded-lg">Sign in</RouterLink>
          </template>
...
// the following will make the user to be authenticated even if the web browser is refreshed 
